    ...
    <body>
       ...
       <footer class="footer absolute inset-x-0 bottom-0 pb-5 overflow-hidden text-center">
            <div class="flex flex-wrap ">
                <div class="w-full overflow-hidden md:w-1/3 order-2 md:order-1">
                    <h1 class="mb-2 underline">Tecnologies</h1>
                    <div class="text-center">
                        <a href="https://laravel.com/" class="logosTecno"><img src="/imatges/laravel.png" alt="Logo de Laravel" height="60" width="60"></a>
                        <a href="https://tailwindcss.com/" class="logosTecno"><img src="/imatges/tailwind.png" alt="Logo de TailwindCSS" height="60" width="60"></a>
                        <a href="https://www.javascript.com/"class="logosTecno"><img src="/imatges/javascript.png" alt="Logo de Javascript" height="60" width="60"></a>
                    </div>
                </div>

                <div class="w-full overflow-hidden md:w-1/3 order-1 md:order-2">
                    <div class="mt-5">
                        <a class="text-black font-bold logo text-5xl">SAPA<span class="text-green3 text-5xl">DIET</span><img class="inline-block ml-2 logoKiwi" src="/imatges/logo.svg" alt="logo kiwi" width="60" height="60"></a>
                    </div>
                    <div class="mt-2">
                ...
                <div class="w-full overflow-hidden md:w-1/3 order-3">
                    <h1 class=" mb-2 underline">Mapa Web</h1>
            ...
            <div class="copyright">
                <p class="text-gray-500">Il·lustracions per Freepik Storyset & Flaticon</p>
            </div>
       </footer>
