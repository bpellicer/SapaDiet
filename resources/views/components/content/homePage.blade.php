    ...
    <div class="w-full flex">
        <div class="mx-auto">
            ...
            <h1 class="titolHomePage">Controlar el que
                menges mai havia
                sigut tan fàcil</h1>
            <p class="leading-relaxed text-sm lg:text-base px-10 md:px-20 lg:pt-5">Porta a terme un control de la teva dieta, calcula quantes kilocalories consumeixes al dia, crea llistes de la compra i molt més.</p>
