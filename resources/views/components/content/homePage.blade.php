    ...
    <div class="w-full flex">
        <div class="mx-auto">
            ...
            <h1 class="titolHomePage">Controlar el que
                menges mai havia
                sigut tan fàcil</h1>
            <p class="leading-relaxed text-xs sm:text-base px-10 md:px-20 lg:pt-5">Porta a terme un control de la teva dieta, calcula quantes kilocalories consumeixes al dia, crea llistes de la compra i molt més.</p>
            <div class="mx-auto px-10 md:px-20 pb-20 pt-2"><a href="" id = "btnInfo" class="botoEstandar inline-block px-5 py-2 text-center mt-5 text-sm"><span class="iconify inline-block mr-2" data-inline="false" data-icon="bi:box-arrow-in-right"></span> Llegeix Més !</a></div>
